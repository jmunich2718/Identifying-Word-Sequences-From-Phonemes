...
def find_next_word(phonemes_clean,i,j,words_so_far, done_flag):
     '''
    Searches for all possible words that match the phoneme sequence. 
...
#            print('No word matches. Incrementing j by 1.')  # Used for debugging.
...
#        print('Match found, now looking for a subsequent word with remaining ',
        ...
        if j+1 >= len(phonemes_clean): 
            done_flag = True
#            print('Done')   # Used for debugging.
            return words_so_far
            

    words_so_far = find_next_word(phonemes_clean, i, j, words_so_far, done_flag)
        
#        print('I am done this pass.')   # Used for debugging.
    #return words_so_far
...
def find_word_combos_with_pronunciation(phonemes):
    ...
    Result = find_next_word(phonemes_clean, 0, 0, words_so_far, False)
